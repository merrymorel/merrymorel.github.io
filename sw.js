...
const CACHE='arcade-v4'; const ASSETS=['./','./index.html','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png','./logo.png','./logo-anim.webp','./logo-anim.gif','./spores.png'];
